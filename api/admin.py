...
from .models import User, Student, Employer, Resume, Job, Match, Subscription, Invoice, Notification
...
class JobAdmin(admin.ModelAdmin):
    """Job admin"""
    list_display = ['title', 'employer', 'location', 'is_open', 'created_at']
...
class InvoiceAdmin(admin.ModelAdmin):
    """Invoice admin"""
    list_display = ['employer', 'job', 'success_fee', 'payment_status', 'issued_at', 'paid_at']
    list_filter = ['payment_status', 'issued_at']
    search_fields = ['employer__company_name']
    readonly_fields = ['invoice_id', 'issued_at']
