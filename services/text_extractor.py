...
class TextExtractionError(Exception):
    ...
    def __init__(self, file_path: str, original_error: Exception):
        ...
        super().__init__(f"Failed to extract text from {file_path}: {str(original_error)}")
...
class TextExtractor:
    ...
    def extract(self, file_path: str) -> str:
        ...
        try:
            ...
            # Wrap any other exceptions in TextExtractionError
    ...
    def _extract_docx(self, file_path: str) -> str:
        ...
        # Extract and join all paragraph text
