...
SUPABASE_SERVICE_ROLE_KEY = config('SUPABASE_SERVICE_KEY', default='') or config('SUPABASE_SERVICE_ROLE_KEY', default='')
SUPABASE_BUCKET_RESUMES = config('SUPABASE_BUCKET_RESUMES', default='resumes')
SUPABASE_BUCKET_PROFILE_IMAGES = config('SUPABASE_BUCKET_PROFILE_IMAGES', default='profile-images')
