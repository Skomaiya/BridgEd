...
from .models import User, Student, Employer, Resume, Job, Match, Subscription, Notification, ContactRequest
...
class StudentAdmin(admin.ModelAdmin):
    """Student admin"""
    list_display = ['user', 'university', 'course', 'is_premium_active', 'profile_completion_percentage']
...
class EmployerAdmin(admin.ModelAdmin):
    ...
    search_fields = ['company_name', 'user__email', 'office_address', 'registration_number']
...
class JobAdmin(admin.ModelAdmin):
    """Job admin"""
    list_display = [
        'title', 'employer', 'location', 'is_open',
        'published_at', 'application_deadline', 'max_shortlist_size',
        'created_at',
    ]
...
class MatchAdmin(admin.ModelAdmin):
    """Match admin"""
    list_display = ['student', 'job', 'compatibility_score', 'student_interested', 'matched_at']
